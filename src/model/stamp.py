...
# https://github.com/datawhalechina/torch-rechub/blob/main/torch_rechub/models/matching/stamp.py

class STAMP(nn.Module):
    def __init__(self, num_users, num_items, embedding_mode, hidden_size=64, weight_std=0.05, emb_std=0.002):
        super().__init__()
